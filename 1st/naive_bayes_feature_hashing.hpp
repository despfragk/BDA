...
#include <vector>
#include "email.hpp"
#include "base_classifier.hpp" // Make sure this file contains the correct definition of BaseClf
...
public:
   ...
   NaiveBayesFeatureHashing(int ngram, int log_num_buckets, double learning_rate)
